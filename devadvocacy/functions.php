...
// function register_services_tray() {a
//   'services-tray' => __('Services Tray Menu')
// }

// add_action('init', 'register_services_tray');
...
function add_taxonomy(){
  ...
  //Add custom category metabox to page
  register_taxonomy_for_object_type('category', 'page');

  // register_taxonomy_for_object_type('custom', 'page');
  ...
  register_taxonomy_for_object_type('custom_cat', 'page' );
  register_taxonomy_for_object_type('custom_cat', 'custom-post-type');
}
