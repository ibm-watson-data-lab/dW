...
function getInfobox() {
  ...
  $.ajax({
    method: "GET",
    url: "https://de352a73-71f2-46b5-a8ee-5f55f9b4c366-bluemix.cloudant.com/repoinfo/_design/views/_view/chrono?reduce=false&include_docs=true&descending=true&limit=2", 
    dataType: "json",
    success: function(data) {
      for (var i = 0; i < 2 && i < data.rows.length; i++) {
